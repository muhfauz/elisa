...
('ADM001', 'Bp.Kyai Ngizudin', 'ADM001', 'e10adc3949ba59abbe56e057f20f883e', 'adm_1656822528.png', 'Suro', '085742906467', 'admin');
...
('ADM001', 'Siska', 'Purwokerto', 'HRD001', '085700487612', 'e10adc3949ba59abbe56e057f20f883e', 'adm_1656820086.JPG', 'tidak_aktif');
...
('LOW001', 'Lowongan Marketing', '<p><strong>SHINTA FASHION MART</strong> merupakan perusahaan yang sedang bertumbuh pesat yang bergerak dalam bidang Fashion, serta merupakan salah satu perusahaan terbesar di Karesidenan Banyumas. Membuka kesempatan kepada kandidat terbaik untuk berkarier dan berkembang bersama kami sebagai :</p>\r\n\r\n<p><strong>Staff Purchasing</strong></p>\r\n\r\n<h3><strong>Kriteria:</strong></h3>\r\n\r\n<ul>\r\n	<li>Pria/Wanita</li>\r\n	<li>Lulusan SMA/K sederajat</li>\r\n	<li>Mampu mengoperasikan MS Office</li>\r\n	<li>Berpengalaman di bidang Administrasi</li>\r\n	<li>Bersedia bekerja sama dalam team</li>\r\n	<li>Komunikatif, jujur dan bertanggung jawab</li>\r\n</ul>\r\n\r\n<p>&nbsp;</p>\r\n', '2022-07-09 00:00:00', '2022-07-15', 'adm_1657323831.png', 'ADM001', 'b81082bdadcffc9717727dc471555102'),
('LOW002', 'Lowongan sale', '<p>akkakak kakak akakka aka akakka</p>\r\n', '2022-07-09 00:00:00', '2022-07-08', 'adm_1657323795.jpg', 'ADM001', '5ade11bf56fb42658825e2897ea39944');
...
INSERT INTO `tbl_pelamar` (`kd_pelamar`, `nama_pelamar`, `nohp_pelamar`, `alamat_pelamar`, `username_pelamar`, `password_pelamar`, `gambar_pelamar`) VALUES
('PEL005', 'aaaaa', 'aaaa', 'aaaa', 'PEL005', 'e10adc3949ba59abbe56e057f20f883e', 'pelamar.png');
...
CREATE TABLE `tbl_seleksi` (
  ...
  `ket_admin tolak/terima` varchar(20) NOT NULL,
  `kd_hrd` varchar(20) NOT NULL,
  `ket_hrd tolak/terima` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_seleksi` (`kd_seleksi`, `tgl_seleksi`, `kd_pelamar`, `kd_lowongan`, `surat_lamaran`, `form_cv`, `fc_ktp`, `fc_sim`, `fc_ijazah`, `fc_skck`, `fc_suratketdokter`, `fc_vaksin2`, `fc_swab`, `fc_sertifikat`, `data_psikotes`, `kd_admin`, `ket_admin tolak/terima`, `kd_hrd`, `ket_hrd tolak/terima`) VALUES
('SEL001', '2022-07-09', '', '6', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('SEL002', '2022-07-09', '', '7', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('SEL003', '2022-07-09', '', '6', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('SEL004', '2022-07-09', '', '6', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
