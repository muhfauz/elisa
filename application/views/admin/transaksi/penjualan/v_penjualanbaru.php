            ...
            <div class="row ml-1 mr-1 bg-blue-gradient ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input class="form-control" name="kd_penjualan" id="kd_penjualan" placeholder="No Tranaksi" type="text" readonly value="<?php echo $this->Mglobal->kode_otomatis('kd_penjualan', 'tbl_penjualan', 'PEN'); ?>" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="namaoutlet" placeholder="Nama outlet" type="text" required>
                ...
                <div class="mt-2 col sm-1 mr-2 mb-0">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input class="form-control" name="tgl_penjualan" id="exampleInputuname3" placeholder="" type="date" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input class="form-control" name="no_fakturpenjualan" id="uang_mukazss" placeholder="Nomor Faktur penjualan" type="text" required>
                ...
                <div class="col-lg-12">
                    <div class="card ">
                        <div class="card-header bg-blue">
                            <h5 class="text-white m-b-0"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Detail Barang</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input class="form-control" placeholder="Nama Barang" type="text" id="nama_barang" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <span class="fa fa-check-square form-control-feedback" aria-hidden="true"></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input class="form-control" placeholder="" type="number" id="stok_pembelian" readonly>
                    ...
                    <tbody>
                        ...
                        foreach ($barang as $p) :  ?>
                            <tr>
                                ...
                                <td class="float-left">
                                    <!-- <a href="#" class="btn btn-info btn-sm mb-1 pilih" data-kodepel="<?php $a->kd_outlet ?>" data-namapel="<?php $a->nama_outlet ?>"> <i class="fa fa-edit mr-2"></i> Pilih</a> -->
                                    <a href="#" class="btn btn-primary pilihbarang" kd_detailpembelian="<?php echo $p->kd_detailpembelian ?>" kd_barang="<?php echo $p->kd_barang ?>" nama_barang="<?php echo $p->nama_barang ?>" stok_pembelian="<?php echo $p->stok_pembelian ?>" hna_std="<?php echo $p->hna_std ?>" ED="<?php echo $p->ED ?>"> <i class="fa fa-check" aria-hidden="true"></i></a>
                                    <!-- <a href="" class="btn btn-primary btn-sm mb-1" data-toggle="modal" data-target="#datadetail<?php echo $a->kd_outlet ?>"> <i class="fa fa-plus-square mr-2"></i> Detail</a> -->
                                    <!-- <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#editdata<?php echo $a->kd_outlet ?>"> <i class="fa fa-edit mr-2"></i> Pilih</a> -->
                                    <!-- <a href="" class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#hapusdata<?php echo $a->kd_outlet ?>"> <i class="fa fa-trash mr-2"></i> Hapus</a> -->
                                </td>
...
<script>
    ...
    $(function() {
        ...
        $('.pilihbarang').click(function() {
            ...
            var stok_pembelian = $(this).attr("stok_pembelian");
            var ED = $(this).attr("ED");
            ...
            $('#stok_pembelian').val(stok_pembelian);
            $('#jumlah_penjualan').val(stok_pembelian);
            $('#ED').val(ED);
        ...
        $('#tambahbarang1').click(function() {
            ...
            if (tombole == 'Tambah') {
                // alert(stok_pembelian);
                var kd_detailpembelian = $('#kd_detailpembelian').val();
                var kd_barang = $('#kd_barang').val();
                var hargajual_barang = $('#hargajual_barang').val();
                let jumlah_penjualan = parseInt($('#jumlah_penjualan').val());
                let stok_pembelian = parseInt($('#stok_pembelian').val());
                var ED = $('#ED').val();
                var kd_penjualan = $('#kd_penjualan').val();
                var total_bayarpenjualan = jumlah_penjualan * hargajual_barang;
                if (kd_barang == "") {
                    ...
                    swal("Peringatan!", "Jumlah Penjualan Harus Diisi!", "warning");
                } else if (jumlah_penjualan > stok_pembelian) {
                    swal("Peringatan!", "Jumlah Penjualan Tidak Boleh Lebih Besar Dari Stok!", "warning");
                } else {
                    $.ajax({
                        type: "POST",
