    ...
    <div class="content">
        ...
        <div class="info-box">
            ...
            <div class="table-responsive">
                ...
                <!-- <a href="<?php echo base_url('admin/penjualan/penjualan/tambahpenjualan') ?>" class="btn btn-primary mb-2"> <i class="fa fa-plus-square mr-2"></i> penjualan Baru</a> -->
                <table id="example1" class="table table-bordered table-striped table-hover">
                    <thead class="bg-blue">
                        <tr>
                            <th class="text-center text-white" width="10px">No</th>
                            <th class="text-center text-white">Kode penjualan</th>
                    ...
                    <tbody>
                        ...
                        foreach ($penjualan as $a) :  ?>
                            <tr>
                                ...
                                <td><?php echo $a->kd_penjualan ?></td>
                                <td><?php echo $a->no_fakturpenjualan ?></td>
                                <td><?php echo $a->nama_outlet ?></td>
                                <td><?php echo $a->alamat_outlet ?></td>
                                <td><?php echo date('d F Y', strtotime($a->tgl_penjualan)) ?></td>

                                <td>Rp. <?php echo number_format($a->total_penjualan) ?></td>


                                <td class="float-left">
                                    <!-- <a href="" class="btn btn-primary btn-sm mb-1" data-toggle="modal" data-target="#datadetail<?php echo $a->kd_penjualan ?>"> <i class="fa fa-plus-square mr-2"></i> Detail</a> -->

                                    <a href="<?php echo base_url('admin/transaksi/penjualan/detailpenjualan/') . $a->kd_penjualan; ?>" class="btn btn-primary btn-sm mb-1"> <i class="fa fa-info-circle" aria-hidden="true"></i> Detail</a>
                                    <a href="<?php echo base_url('admin/transaksi/penjualan/editpenjualan/') . $a->kd_penjualan; ?>" class="btn btn-info btn-sm mb-1"> <i class="fa fa-edit mr-2"></i> Edit</a>
...
<?php foreach ($penjualan as $a) : ?>
    ...
    <div class="modal fade" id="selesaidata<?php echo $a->kd_penjualan ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header bg-facebook text-white">
                    <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa fa-check mr-2"></i> penjualan Selesai</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/penjualan/penjualan/penjualanselesai') ?>" method="post">
                        <div class="form-group">
