            ...
            <div class="row ml-1 mr-1 bg-blue-gradient ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input class="form-control" name="kd_pembelian" id="kd_pembelian" placeholder="No Tranaksi" type="text" readonly value="<?php echo $this->Mglobal->kode_otomatis('kd_pembelian', 'tbl_pembelian', 'PEM'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="namasuplier" placeholder="Nama Suplier" type="text" required>
                ...
                <div class="mt-2 col sm-1 mr-2 mb-0">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input class="form-control" name="tgl_pembelian" id="exampleInputuname3" placeholder="" type="date" value="<?php echo date('Y-m-d') ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input class="form-control" name="no_fakturpembelian" id="uang_mukazss" placeholder="Nomor Faktur Pembelian" type="text" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <span class="fa fa-database form-control-feedback" aria-hidden="true"></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <span class="fa fa-krw form-control-feedback" aria-hidden="true"></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
