  ...
  <div class="content">
    ...
    <div class="info-box">
      ...
      <div class="table-responsive">
        ...
        <a href="<?php echo base_url('admin/laporan/lpelanggan/laporan_pdf_pelanggan') ?>" class="btn btn-secondary mb-2 text-center"> <i class="fa fa-print mr-2"></i>Cetak PDF</a>
        <table id="example1" class="table table-bordered table-striped table-hover">
          <thead class="bg-aqua">
            <tr>
              <th class="text-center text-white" width="10px">No</th>
              <th class="text-center text-white">Kode Pelanggan</th>
              <th class="text-center text-white">Nama Pelenggan</th>
              <th class="text-center text-white">Alamat Pelenggan</th>
              <th class="text-center text-white">No HP Pelenggan</th>
