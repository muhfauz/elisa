  ...
  <table>
    ...
    foreach ($pembelian as $a) : $no++; ?>
      ...
      <tr>
        ...
        <td style="text-align: right;"> <?php echo number_format($a->hna_std) ?> </td>
        <td style="text-align: right;"> <?php echo number_format($a->total_bayar) ?> </td>
