...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="info-box">
            ...
            <p>
                <a class="btn btn-primary all" href="<?php echo base_url('admin/laporan/lpembelian/lihat') ?>">
                    <i class="fa fa-shopping-cart mr-2 semua" aria-hidden="true"></i>Semua Pembelian
                </a>
                ...
                <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#bydate" aria-expanded="false" aria-controls="collapseExample">
                    <i class="fa fa-shopping-cart mr-2" aria-hidden="true"></i> Pembelian By Date
                </button>
            </p>
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline">
                                <div class="card-header bg-blue">
                                    <h5 class="text-white text-lg-center m-b-0">Masukkan Tanggal Pembelian</h5>
                                </div>
                                <div class="card-body">
                                    <form action="<?php echo base_url('admin/laporan/lpembelian/tanggal') ?>" method="POST">
