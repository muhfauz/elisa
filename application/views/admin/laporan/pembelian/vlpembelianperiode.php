  ...
  <div class="content">
    ...
    <div class="info-box">
      ...
      <div class="table-responsive">
        ...
        <a href="<?php echo base_url('admin/laporan/lpembelian/laporan_pdf_pembelianperiode') ?>" class="btn btn-secondary bg-aqua-gradient mb-2 text-center"> <i class="fa fa-print mr-2"></i>Cetak PDF</a>
          ...
          <tbody>
            ...
            foreach ($pembelian as $a) :  ?>
              <tr>
                ...
                <td> <?php echo $a->jumlah_pembelian . ' ' . $a->nama_satuan ?> </td>
                <td class="text-right"> <?php echo number_format($a->hna_std) ?> </td>
                <td class="text-right"> <?php echo number_format($a->total_bayar) ?> </td>
