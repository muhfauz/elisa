  ...
  <div class="content">
    ...
    <div class="info-box">
      ...
      <div class="table-responsive">
        ...
        <a href="<?php echo base_url('admin/laporan/ladmin/laporan_pdf_admin') ?>" class="btn btn-secondary bg-aqua-gradient mb-2 text-center"> <i class="fa fa-print mr-2"></i>Cetak PDF</a>
  ...
  <div class="modal fade" id="editdata<?php echo $a->kd_admin ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo base_url('admin/master/admin/aksieditadmin') ?>" method="post">
            <div class="form-group">
              <label for="">Nama</label>
              <input name="nama_admin" type="text" class="form-control" value="<?php echo $a->nama_admin ?>" required>
              <input name="kd_admin" type="hidden" class="form-control" value="<?php echo $a->kd_admin ?>" required>
            ...
            <div class="form-group">
              <label for="">Username</label>
              <input name="username_admin" type="text" class="form-control" value="<?php echo $a->username_admin ?>" required>
            </div>
