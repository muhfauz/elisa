        ...
        <div class="info-box">
            ...
            <div class="row ml-1 mr-1 mt-3 bg-blue-gradient ">
                <div class="col sm-1 mt-2 ml-2 mr-2">
                    ...
                    <div class="form-group row">
                        <label for="exampleInputEmail3" class="col-sm-3 control-label">Tinkgat </label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input class="form-control" name="kd_outlet" id="kd_outlet" placeholder="Nama outlet" type="hidden">
                                <input class="form-control" id="namaoutlet" placeholder="Nama outlet" type="text" value="<?php echo $tingkat ?>" readonly>
                                <div class="input-group-addon"><i class="fa fa-check" aria-hidden="true"></i></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row ml-1 mr-1 mt-3 bg-blue-gradient ">
                ...
                <div class="col-4 sm-8 mt-2 ml-2 mr-2 mb-2">
                    ...
                    <?php if ($totalspp > 0) { ?>
                        <a href="<?php echo base_url('admin/laporan/lspp/laporan_pdf_spp_tingkat') ?>">
