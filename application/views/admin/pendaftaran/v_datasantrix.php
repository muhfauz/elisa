                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group has-feedback">
                                                <label class="custom-file center-block block">
                                                    <input name="foto_santri" id="file" class="custom-file-input" type="file" required>
                                                    <span style="color:red;">Akte / Surat Kelahiran/KTP</span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group has-feedback">
                                                <label class="custom-file center-block block">
                                                    <input name="foto_santri" id="file" class="custom-file-input" type="file" required>
                                                    <span style="color:red;">Scan KK</span>
                                                    <span class="custom-file-control"></span> </label>
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-12">
