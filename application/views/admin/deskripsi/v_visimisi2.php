          ...
          <tbody>
            ...
            foreach ($visimisi as $a) :  ?>
              <tr>
                ...
                <!-- <td> <img class="img-thumbnail" src=" <?php echo base_url('gambar/') . $a->gambar_visimisi ?>" alt=""> </td> -->
...
<?php foreach ($visimisi as $a) : ?>
  <div class="modal fade" id="datadetail<?php echo $a->kd_visimisi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header bg-aqua">
          <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa fa-user-circle-o mr-2"></i> Visi Misi Kami</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div class="modal-body">
          <form action="<?php echo base_url('admin/master/admin/hapusadmin') ?>" method="post">
            <div class="form-group">
              ...
              <input name="kd_admin" type="hidden" class="form-control" value="<?php echo $a->kd_visimisi ?>" required>
            </div>
        ...
        <div class="modal-body">
          <form action="<?php echo base_url('admin/deskripsi/visimisi/aksieditvisimisi') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="isi_visimisi" id="isi_visimisi" cols="30" rows="10"><?php echo $a->isi_visimisi ?></textarea>
            </div>
            ...
            <!-- <div class="form-group">
              ...
              <br>
              <input name="gambar_visimisi" type="file" class="form-control" value="">
            </div> -->
