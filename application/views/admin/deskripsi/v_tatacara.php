                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    <thead class=" bg-aqua-gradient ">
                        <tr>
                            ...
                            <th class="text-center text-white">tatacara Kami</th>
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        foreach ($tatacara as $a) :  ?>
                            <tr>
                                <td class="text-center font-weight-bold"><?php echo $no++; ?></td>
                                <td><?php echo $a->judul_tatacara ?></td>
                                <td><?php echo substr($a->isi_tatacara, 0, 200) . '...';  ?></td>
                                <!-- <td> <img class="img-thumbnail" src=" <?php echo base_url('gambar/') . $a->gambar_tatacara ?>" alt=""> </td> -->
                                <td class="float-right">

                                    <a href="" class="btn btn-primary btn-sm mb-1" data-toggle="modal" data-target="#datadetail<?php echo $a->kd_tatacara ?>"> <i class="fa fa-plus-square mr-2"></i> Detail</a>
                                    <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#editdata<?php echo $a->kd_tatacara ?>"> <i class="fa fa-edit mr-2"></i> Edit</a>
...
<!-- modal detail -->
<?php foreach ($tatacara as $a) : ?>
    <div class="modal fade" id="datadetail<?php echo $a->kd_tatacara ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-aqua">
                    <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa fa-user-circle-o mr-2"></i> Detail tatacara Kami</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <table class="table table-borderless">
                        ...
                        <!-- <tr>
                            ...
                            <td class="image text-center">
                                <img width="100" height="100" src="<?php echo base_url('gambar/') . $a->gambar_tatacara ?>" alt="">
                            </td>
                        </tr> -->
                    </table>
...
<?php foreach ($tatacara as $a) : ?>
    ...
    <div class="modal fade" id="hapusdata<?php echo $a->kd_tatacara ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <input name="nama_admin" type="text" class="form-control" value="<?php echo $a->nama_admin ?>" required> -->
                            <input name="kd_admin" type="hidden" class="form-control" value="<?php echo $a->kd_tatacara ?>" required>
                        </div>
...
<?php foreach ($tatacara as $a) : ?>
    ...
    <div class="modal fade" id="editdata<?php echo $a->kd_tatacara ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-aqua">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/pendaftaran/tatacara/aksiedittatacara') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="">Judul</label>
                            <input name="judul_tatacara" type="text" class="form-control" value="<?php echo $a->judul_tatacara ?>" required>
                            <input name="kd_tatacara" type="hidden" class="form-control" value="<?php echo $a->kd_tatacara ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="">Deskripsi</label>

                            <textarea class="form-control" name="isi_tatacara" id="isi_tatacara" cols="30" rows="10"><?php echo $a->isi_tatacara ?></textarea>
                        </div>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <img width="100" height="100" src="<?php echo base_url('gambar/') . $a->gambar_tatacara ?>" alt="">
                            <br>
                            <input name="gambar_tatacara" type="file" class="form-control" value="">
                        </div> -->
