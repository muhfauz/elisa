                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    <thead class=" bg-aqua-gradient ">
                        <tr>
                            ...
                            <th class="text-center text-white">Sejarah Kami</th>
                            <th class="text-center text-white">Gambar</th>
                            <th class="text-center text-white">Keterangan Sambar</th>
                    ...
                    <tbody>
                        ...
                        foreach ($sejarah as $a) :  ?>
                            <tr>
                                ...
                                <td><?php echo $a->judul_sejarah ?></td>
                                <td><?php echo substr($a->isi_sejarah, 0, 200) . '...';  ?></td>
                                <td> <img class="img-thumbnail" src=" <?php echo base_url('gambar/') . $a->gambar_sejarah ?>" alt=""> </td>
                                <td><?php echo $a->judul_gambar ?></td>
                                <td class="float-right">

                                    <a href="" class="btn btn-primary btn-sm mb-1" data-toggle="modal" data-target="#datadetail<?php echo $a->kd_sejarah ?>"> <i class="fa fa-plus-square mr-2"></i> Detail</a>
                                    <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#editdata<?php echo $a->kd_sejarah ?>"> <i class="fa fa-edit mr-2"></i> Edit</a>
...
<!-- modal detail -->
<?php foreach ($sejarah as $a) : ?>
    <div class="modal fade" id="datadetail<?php echo $a->kd_sejarah ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-aqua">
                    <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa fa-user-circle-o mr-2"></i> Detail sejarah Kami</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <th>Deksripsi</th>
                            <td><?php echo $a->isi_sejarah ?></td>
                        </tr>
                        <tr>
                            <th>Foto</th>
                            <td class="image text-center">
                                <img width="100" height="100" src="<?php echo base_url('gambar/') . $a->gambar_sejarah ?>" alt="">
                            </td>
                        </tr>
                        <tr>
                            <th>Ket Gambar</th>
...
<?php foreach ($sejarah as $a) : ?>
    ...
    <div class="modal fade" id="hapusdata<?php echo $a->kd_sejarah ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <input name="nama_admin" type="text" class="form-control" value="<?php echo $a->nama_admin ?>" required> -->
                            <input name="kd_admin" type="hidden" class="form-control" value="<?php echo $a->kd_sejarah ?>" required>
                        </div>
...
<?php foreach ($sejarah as $a) : ?>
    ...
    <div class="modal fade" id="editdata<?php echo $a->kd_sejarah ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-aqua">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/deskripsi/sejarah/aksieditsejarah') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="">Judul</label>
                            <input name="judul_sejarah" type="text" class="form-control" value="<?php echo $a->judul_sejarah ?>" required>
                            <input name="kd_sejarah" type="hidden" class="form-control" value="<?php echo $a->kd_sejarah ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="">Deskripsi</label>
                            <textarea class="form-control" name="isi_sejarah" id="isi_sejarah" cols="30" rows="100"><?php echo $a->isi_sejarah ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <img width="100" height="100" src="<?php echo base_url('gambar/') . $a->gambar_sejarah ?>" alt="">
                            <br>
                            <input name="gambar_sejarah" type="file" class="form-control" value="">
                        </div>
                        <div class="form-group">
                            <label for="">Ket Gambar</label>
                            <input name="judul_gambar" type="text" class="form-control" value="<?php echo $a->judul_gambar ?>" required>
