                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    <thead class=" bg-aqua-gradient ">
                        <tr>
                            ...
                            <th class="text-center text-white">struktur Kami</th>
                    ...
                    <tbody>
                        ...
                        foreach ($struktur as $a) :  ?>
                            <tr>
                                ...
                                <td><?php echo substr($a->ket_struktur, 0, 200) . '...';  ?></td>
                                <td> <img class="img-thumbnail" src=" <?php echo base_url('gambar/') . $a->gambar_struktur ?>" alt=""> </td>
...
<?php foreach ($struktur as $a) : ?>
    <div class="modal fade" id="datadetail<?php echo $a->kd_struktur ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-aqua">
                    <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa fa-user-circle-o mr-2"></i> Detail struktur Kami</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <input name="nama_admin" type="text" class="form-control" value="<?php echo $a->nama_admin ?>" required> -->
                            <input name="kd_admin" type="hidden" class="form-control" value="<?php echo $a->kd_struktur ?>" required>
                        </div>
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/deskripsi/struktur/aksieditstruktur') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="ket_struktur" id="ket_struktur" cols="30" rows="10"><?php echo $a->ket_struktur ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <img width="100" height="100" src="<?php echo base_url('gambar/') . $a->gambar_struktur ?>" alt="">
                            <br>
                            <input name="gambar_struktur" type="file" class="form-control" value="">
                        </div>
