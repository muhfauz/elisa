        ...
        <div class="info-box">
            ...
            <div class="row ml-1 mr-1 mt-3 bg-aqua">
                <div class="col sm-1 mt-2 ml-2 mr-2">
                    <!-- <form class="form" action="<?php echo base_url('admin/transaksi/penjualan/simpanpenjualan') ?>" method="POST"> -->
                    <div class="form-group row">
                        <label for="exampleInputuname3" class="col-sm-3 control-label">Total hrd</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input class="form-control text-right" name="kd_penjualan" id="kd_penjualan" placeholder="No Tranaksi" type="text" readonly value="<?php echo $jumlah_hrd ?> orang" required>
                                <div class="input-group-addon"><i class="fa fa-check" aria-hidden="true"></i></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td><?php echo $a->tempatlahir_hrd . ', ' . $this->Mglobal->tanggalindo($a->tgllahir_hrd) ?></td>
                        </tr>
                        <tr>
                            <th>Jenis Kelamin </th>
                            <td><?php echo $a->jk_hrd ?></td>
                        </tr>
                        <tr>
                            <th>Alamat </th>
                        ...
                        <tr>
                            ...
                            <td><?php echo $a->pendidikan_hrd ?></td>
                        </tr>

                        <tr>
                            <th>Tanggal Register </th>
                            <td><?php echo $this->Mglobal->tanggalindo($a->tglregister_hrd) ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>Foto hrd</th>
                            <td>
                                <img height="100" width="100" src="<?php echo base_url('gambar/') . $a->gambar_hrd ?>" alt="">
                            </td>
                        </tr>
    ...
    <div class="modal fade" id="tolakdata<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksi/tolakhrd') ?>" method="post">
                        <div class="form-group">
                            Apakah Anda Yakin akan Menolak Seleksi hrd ini? <br>
    ...
    <div class="modal fade" id="terimadata<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksi/terimahrd') ?>" method="post">
                        <div class="form-group">
                            Apakah hrd ini ikut ke Tahap Seleksi Selanjutnya? <br>
                            <label for="">Alasan :</label>
                            <input name="alasan_admin" type="text" class="form-control" required>
                            <input name="kd_seleksi" type="hidden" class="form-control" value="<?php echo $a->kd_seleksi ?>" required>
                        </div>
...
<?php foreach ($seleksi as $a) : ?>
    <div class="modal fade" id="uploadsuratlamaran<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksihrd/uploadsuratlamaran') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
                            <label for="">Surat lamaran :</label>
                            <input name="surat_lamaran" type="file" class="form-control" required>
                            <input name="kd_seleksi" type="hidden" class="form-control" value="<?php echo $a->kd_seleksi ?>" required>
...
<!-- upload cv -->
<?php foreach ($seleksi as $a) : ?>
    <div class="modal fade" id="uploadcv<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa fa-file-pdf-o mr-2"></i> Upload Dokumen</h5>
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksihrd/uploadcv') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
                            <label for="">CV :</label>
                            <input name="form_cv" type="file" class="form-control" required>
                            <input name="kd_seleksi" type="hidden" class="form-control" value="<?php echo $a->kd_seleksi ?>" required>
                            <input name="kd_lowongan" type="hidden" class="form-control" value="<?php echo $a->kd_lowongan ?>" required>
                        </div>
    ...
    <div class="modal fade" id="uploadijazah<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksihrd/uploadijazah') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
    ...
    <div class="modal fade" id="uploadskck<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksihrd/uploadskck') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
    ...
    <div class="modal fade" id="uploadsuratketdokter<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksihrd/uploadsuratketdokter') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
    ...
    <div class="modal fade" id="uploadvaksin2<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksihrd/uploadvaksin2') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
    ...
    <div class="modal fade" id="uploadswab<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksihrd/uploadswab') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
    ...
    <div class="modal fade" id="uploadktp<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksihrd/uploadktp') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
                            <label for="">KTP :</label>
    ...
    <div class="modal fade" id="uploadkk<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksihrd/uploadkk') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
    ...
    <div class="modal fade" id="uploadsertifikat<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksihrd/uploadsertifikat') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
    ...
    <div class="modal fade" id="uploadsim<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksihrd/uploadsim') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
                            <label for="">SIM :</label>
