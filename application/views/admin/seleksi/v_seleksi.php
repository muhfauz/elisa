                            ...
                            <tr>
                                ...
                                <td class="float-right">
                                    <?php if ($a->status_daftar == "lengkap") { ?>
                                        ...
                                        <a href="" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#terimadata<?php echo $a->kd_santri ?>"> <i class="fa fa-edit mr-2"></i> Terima Santri</a>
                                        <a href="" class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#tolakdata<?php echo $a->kd_santri ?>"> <i class="fa fa-trash mr-2"></i> Tolak Santri</a>
...
<?php foreach ($santri as $a) : ?>
    ...
    <div class="modal fade" id="tolakdata<?php echo $a->kd_santri ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa fa-user-circle-o mr-2"></i> Tolak Santri</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksi/tolaksantri') ?>" method="post">
                        <div class="form-group">
                            Apakah Anda Yakin akan Menolak Santri ini? <br>
    ...
    <div class="modal fade" id="terimadata<?php echo $a->kd_santri ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksi/terimasantri') ?>" method="post">
                        <div class="form-group">
