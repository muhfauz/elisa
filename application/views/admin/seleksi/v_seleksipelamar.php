    ...
    <div class="modal fade" id="uploadsuratlamaran<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksipelamar/uploadsuratlamaran') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
    ...
    <div class="modal fade" id="uploadcv<?php echo $a->kd_seleksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/seleksi/seleksipelamar/uploadcv') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            Pilih Dokumen <br>
                            <label for="">CV :</label>
