...
<section class="section-content-block">
    ...
    <div class="container wow fadeInUp">
        ...
        <div class="row">
            ...
            <div class="service-carousel owl-carousel" data-dots="false" data-items="4">
            ...
            <div class="col-sm-12 text-center">
                ...
                <a href="#" class="btn btn-theme margin-top-24 btn-square">LOAD ALL PACKAGES</a>
...
<section class="section-feat-about-us section-custom-bg  section-curve-white-overlary" data-bg_img="images/about_us_info_bg.jpg" data-bg_color="#111111" data-bg_opacity="0.7">

    <div class="side-background">
        <div class="col-md-6 feat-img-side-bg visible-lg">
            <div class="row">
                <img src="<?php echo base_url('assets/depan/') ?>images/about_feat_bg_2.jpg" alt="">
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="about-us-info  text-left">
                        ...
                        <h3 class="about-us-slogan about-us-slogan-bold text-light-color">
                            WE <i class="text-curly text-highlighter-primary">CREATE</i> GREAT SWIMMERS !<br>
                        </h3>

                        <div class="margin-top-48 text-light-color">

                            <p class="text-light-color padding-top-24">
                                We teach your children to become a fish in the water with the most advanced swimming techniques invented
                                by world's best swimming instructors. Our environment is safe and comfortable.
                            </p>

                            <div class="about-details">

                                <ul class="custom-bullet-list custom-icon">
                                    <li>Member of the United States Swim School Association.</li>
                                    <li>Been training people for over 25 years.</li>
                                    <li>Trained over ten thousand swimmers.</li>
                                    <li>Our instructors are national gold medalists .</li>
                                    <li>Our environment is safe, fun and comfortable.</li>
                            ...
                            <p class="margin-top-24 text-light-color">
                                <a href="#" class="btn btn-theme">LEARN ABOUT US</a>
                            </p>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    ...
                    <div class="">
                        ...
                        <div class="col-md-12 col-sm-12 text-left margin-bottom-32">
                            <h2 class="block-heading-title">Why Swim Easy?</h2>
                            <p>
                                We teach your children to become a fish in the water with the most advanced swimming techniques invented by world's best
                                swimming instructors. Our environment is safe and comfortable. We reward our trainees so
                                that they push themselves better and harder.
                            </p>
                        </div> <!-- end .col-sm-12  -->
                    ...
                    <div class="col-md-6">
                        <div class="highlight-layout-2">
                            ...
                            <div class="highlight-text">
                                <h5><a href="#">25 Years Of Service</a></h5>
                                <div>Lorem ipsum dolor sit amet diam integrer eapri. Per fugitzril apeirian cumea aseaap pareat euripidi utmel.</div>
                    ...
                    <div class="col-md-6">
                        <div class="highlight-layout-2">
                            ...
                            <div class="highlight-text">
                                <h5><a href="#">Trained 10k Swimmers</a></h5>
                                <div>Lorem ipsum dolor sit amet diam integrer eapri. Per fugitzril apeirian cumea aseaap pareat euripidi utmel.</div>
                            </div> <!-- end .service-text  -->
                    ...
                    <div class="col-md-6">
                        <div class="highlight-layout-2">
                            ...
                            <div class="highlight-text">
                                <h5><a href="#">Gold Medalist Trainers</a></h5>
                                <div>Lorem ipsum dolor sit is amet diam integrer eapri. Per fugitzril apeirian aseaap cumea pareat euripidi peirian cumea aseaap utmel raeci.</div>
                            </div> <!-- end .service-text  -->
                    ...
                    <div class="col-md-6">
                        <div class="highlight-layout-2">
                            ...
                            <div class="highlight-text">
                                <h5><a href="#">Safe & Fun Environment</a></h5>
                                <div>Lorem ipsum dolor sit is amet diam integrer eapri. Per fugitzril apeirian aseaap cumea pareat euripidi peirian cumea aseaap utmel raeci.</div>
                            </div> <!-- end .service-text  -->
            ...
            <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="appointment-form-wrapper light-layout margin-bottom-0 clearfix">

                    <div class="appointment-form-heading text-center margin-bottom-24">
                        <h2 class="form-title text-capitalize">
                            Register Now
                        </h2>
                    ...
                    <form class="appoinment-form">
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12 text-left margin-bottom-24">
                            <button id="btn_submit" class="btn btn-lg btn-theme btn-theme-invert btn-small btn-block wow fadeIn" type="submit">Send Message</button>
                        </div>
...
<section class="section-content-block section-custom-bg" data-bg_img="images/appointment_bg.jpg" data-bg_color="#111111" data-bg_opacity="0" data-bg_attachment="fixed" data-stellar-background-ratio="0.4">

    <div class="container">

        <div class="row text-center">

            <div class="cta-layout-01 wow zoomInUp">
...
<section class="section-content-block section-secondary-bg  section-curve-white-overlary">
    ...
    <div class="container">
        ...
        <div class="row section-heading-wrapper">
            ...
            <div class="col-md-12 col-sm-12 text-center">
                <h4 class="heading-alt-style text-capitalize text-dark-color">our instructors</h4>
                <span class="heading-separator heading-separator-horizontal"></span>
                <h2 class="subheading-alt-style">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit curabitur eu ante non ex lobortis posuere
                    <br />
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-8 col-xs-offset-2 col-sm-offset-0 col-md-offset-0">

                <div class="team-layout-1 text-center">

                    <figure class="team-member">
                        <a href="#" title="MELISSA MUNOZ">
                            <img src="images/team_5.jpg" alt="MELISSA MUNOZ" />
                        </a>
                ...
                <div class="team-layout-1 text-center">
                    ...
                    <figure class="team-member">
                        <a href="#" title="ALEXANDER GARY">
                            <img src="<?php echo base_url('assets/depan/') ?>images/team_6.jpg" alt="ALEXANDER GARY" />
                        </a>
                    </figure> <!-- end. team-member  -->
                ...
                <div class="team-layout-1 text-center">
                    ...
                    <figure class="team-member">
                        <a href="#" title="JOHN ABRAHAM">
                            <img src="<?php echo base_url('assets/depan/') ?>images/team_7.jpg" alt="JOHN ABRAHAM" />
                        </a>
                    </figure> <!-- end. team-member  -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-8 col-xs-offset-2 col-sm-offset-0 col-md-offset-0">
                ...
                <div class="team-layout-1 text-center">
                    ...
                    <figure class="team-member">
                        <a href="#" title="JOHN ABRAHAM">
                            <img src="<?php echo base_url('assets/depan/') ?>images/team_8.jpg" alt="JOHN ABRAHAM" />
                        </a>
                    </figure>
    ...
    <div class="container theme-custom-box-shadow section-secondary-bg">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 hidden-md hidden-xs hidden-sm no-padding">
                <figure>
                    <img src="<?php echo base_url('assets/depan/') ?>images/testimony_feat_img.jpg" alt="" class="db" />
                </figure>
            </div>
...
<section class="section-content-block section-content-block-minimal section-custom-bg section-curve-white-overlary" data-bg_img="images/cta_bg.jpg" data-bg_color="#5ac4de" data-bg_opacity="0.8">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="counter-block-2 light-counter-layout counter-border">
                    ...
                    <div class="count-info">
                        ...
                        <p class="text-uppercase">Years Experience</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="counter-block-2 light-counter-layout counter-border">
                    ...
                    <div class="count-info">
                        ...
                        <p class="text-uppercase">Happy Trainee</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="counter-block-2 light-counter-layout counter-border">
                    ...
                    <div class="count-info">
                        ...
                        <p class="text-uppercase">Expert Trainer</p>
                    </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="counter-block-2 light-counter-layout counter-border">
                    ...
                    <div class="count-info">
                        ...
                        <p class="text-uppercase">National Award</p>
                    </div>
...
<section class="section-content-block section-gallery-bg">
    ...
    <div class="container">
        ...
        <div class="row section-heading-wrapper">
            ...
            <div class="col-md-12 col-sm-12 text-center">
                <h4 class="heading-alt-style text-capitalize text-dark-color">Photo Gallery</h4>
                <span class="heading-separator heading-separator-horizontal"></span>
                <h2 class="subheading-alt-style">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit curabitur eu ante non ex lobortis posuere
                    <br />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-container">
                ...
                <a class="gallery-light-box xs-margin" data-gall="myGallery" href="images/gallery_1.jpg">
                    ...
                    <figure class="gallery-img">
                        ...
                        <img src="<?php echo base_url('assets/depan/') ?>images/gallery_1.jpg" alt="gallery image" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-container">
                ...
                <a class="gallery-light-box xs-margin" data-gall="myGallery" href="images/gallery_2.jpg">
                    ...
                    <figure class="gallery-img">
                        ...
                        <img src="<?php echo base_url('assets/depan/') ?>images/gallery_2.jpg" alt="gallery image" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-container">
                ...
                <a class="gallery-light-box xs-margin" data-gall="myGallery" href="images/gallery_3.jpg">
                    ...
                    <figure class="gallery-img">
                        ...
                        <img src="<?php echo base_url('assets/depan/') ?>images/gallery_3.jpg" alt="gallery image" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-container filter spray">
                ...
                <a class="gallery-light-box xs-margin" data-gall="myGallery" href="images/gallery_4.jpg">
                    ...
                    <figure class="gallery-img">
                        ...
                        <img src="<?php echo base_url('assets/depan/') ?>images/gallery_4.jpg" alt="gallery image" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-container">
                ...
                <a class="gallery-light-box xs-margin" data-gall="myGallery" href="images/gallery_5.jpg">
                    ...
                    <figure class="gallery-img">
                        ...
                        <img src="<?php echo base_url('assets/depan/') ?>images/gallery_5.jpg" alt="gallery image" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-container">
                ...
                <a class="gallery-light-box xs-margin" data-gall="myGallery" href="images/gallery_6.jpg">
                    ...
                    <figure class="gallery-img">
                        ...
                        <img src="<?php echo base_url('assets/depan/') ?>images/gallery_6.jpg" alt="gallery image" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-container">
                ...
                <a class="gallery-light-box xs-margin" data-gall="myGallery" href="images/gallery_7.jpg">
                    ...
                    <figure class="gallery-img">
                        ...
                        <img src="<?php echo base_url('assets/depan/') ?>images/gallery_7.jpg" alt="gallery image" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 gallery-container">
                ...
                <a class="gallery-light-box xs-margin" data-gall="myGallery" href="images/gallery_8.jpg">
                    ...
                    <figure class="gallery-img">
                        ...
                        <img src="<?php echo base_url('assets/depan/') ?>images/gallery_8.jpg" alt="gallery image" />
...
<section class="section-content-block  section-curve-primary-overlary">
    ...
    <div class="container">
        ...
        <div class="row section-heading-wrapper">
            ...
            <div class="col-md-12 col-sm-12 text-center">
                <h4 class="heading-alt-style text-capitalize text-dark-color">Our Sponsors</h4>
                <span class="heading-separator heading-separator-horizontal"></span>
                <h2 class="subheading-alt-style">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit curabitur eu ante non ex lobortis posuere
                    <br />
        ...
        <div class="row">
            ...
            <div class="logo-layout-1 logo-items owl-carousel" data-nav="true" data-dots="false" data-items="6">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div class="client-logo">
                        ...
                        <img src="<?php echo base_url('assets/depan/') ?>images/logo_6.png" alt="" />
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div class="client-logo">
                        ...
                        <img src="<?php echo base_url('assets/depan/') ?>images/logo_7.png" alt="" />
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div class="client-logo">
                        <img src="<?php echo base_url('assets/depan/') ?>images/logo_8.png" alt="" />
                    </div>
                </div>
