        ...
        <div class="row">
                ...
                <div class="company-card">
                    <div class="company-logo">
                        <a href="job-grid.html">
                            <img src="<?php echo base_url() ?>asset/img/top-company/1.png" alt="company logo">
                        </a>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="company-card">
                    <div class="company-logo">
                        <a href="job-grid.html">
                            <img src="<?php echo base_url() ?>asset/img/top-company/2.png" alt="company logo">
                        </a>
                    </div>
                    <div class="company-text">
                        <h3>Trout Design</h3>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="company-card">
                    <div class="company-logo">
                        <a href="job-grid.html">
                            <img src="<?php echo base_url() ?>asset/img/top-company/3.png" alt="company logo">
                        </a>
                    </div>
                    <div class="company-text">
                        <h3>Resland LTD</h3>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="company-card">
                    <div class="company-logo">
                        <a href="job-grid.html">
                            <img src="<?php echo base_url() ?>asset/img/top-company/4.png" alt="company logo">
                        </a>
                    </div>
                    <div class="company-text">
                        <h3>Lawn Hopper</h3>
        ...
        <div class="condidate-slider owl-carousel owl-theme">
            <div class="condidate-item">
                <div class="candidate-img">
                    <img src="<?php echo base_url() ?>asset/img/candidate/1.jpg" alt="candidate image">
                </div>
            ...
            <div class="condidate-item">
                <div class="candidate-img">
                    <img src="<?php echo base_url() ?>asset/img/candidate/2.jpg" alt="candidate image">
                </div>
                <div class="candidate-social">
                    <a href="#" target="_blank"><i class='bx bxl-facebook'></i></a>
                    <a href="#" target="_blank"><i class='bx bxl-twitter'></i></a>
            ...
            <div class="condidate-item">
                <div class="candidate-img">
                    <img src="<?php echo base_url() ?>asset/img/candidate/3.jpg" alt="candidate image">
                </div>
                <div class="candidate-social">
                    <a href="#" target="_blank"><i class='bx bxl-facebook'></i></a>
                    <a href="#" target="_blank"><i class='bx bxl-twitter'></i></a>
            ...
            <div class="condidate-item">
                <div class="candidate-img">
                    <img src="<?php echo base_url() ?>asset/img/candidate/4.jpg" alt="candidate image">
                </div>
                <div class="candidate-social">
                    <a href="#" target="_blank"><i class='bx bxl-facebook'></i></a>
                    <a href="#" target="_blank"><i class='bx bxl-twitter'></i></a>
            ...
            <div class="testimonial-slider owl-carousel owl-theme">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-6 offset-md-3 offset-lg-0 p-0">
                            <div class="testimonial-img">
                                <img src="<?php echo base_url() ?>asset/img/testimonial-img.jpg" alt="testimonial image">
                            </div>
                ...
                <div class="testimonial-items">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-6 offset-md-3 offset-lg-0 p-0">
                            <div class="testimonial-img">
                                <img src="<?php echo base_url() ?>asset/img/testimonial-img-2.jpg" alt="testimonial image">
                            </div>
                            <div class="testimonial-img-text">
                                <h3>John Doe</h3>
                                <p>Web Designer</p>
        ...
        <div class="row">
                ...
                <div class="blog-card">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="<?php echo base_url() ?>asset/img/blog/1.jpg" alt="blog image">
                        </a>
                    </div>
                    <div class="blog-text">
                        <ul>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="blog-card">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="<?php echo base_url() ?>asset/img/blog/2.jpg" alt="blog image">
                        </a>
                    </div>
                    <div class="blog-text">
                        <ul>
            ...
            <div class="col-lg-4 col-sm-6 offset-sm-3 offset-lg-0">
                <div class="blog-card">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="<?php echo base_url() ?>asset/img/blog/3.jpg" alt="blog image">
                        </a>
                    </div>
                    <div class="blog-text">
                        <ul>
